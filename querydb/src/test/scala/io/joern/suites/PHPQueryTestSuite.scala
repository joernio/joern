...
/** 
  * A test suite for running security queries on PHP code.
  * This suite is built on top of `PhpCode2CpgFixture` to support Code Property Graph (CPG) analysis.
  * 
  * @param queryBundle The set of security queries to be tested.
  */
class PHPQueryTestSuite[QB <: QueryBundle](val queryBundle: QB)
    extends PhpCode2CpgFixture(runOssDataflow = true) {
  ...
  /** 
    * Concatenates all positive and negative query code examples 
    * to construct a representative CPG for testing.
    */
  ...
  /** 
    ...
    * 
    * @param snippets List of PHP code snippets
    * @return A constructed CPG from the provided snippets
    */
  ...
  /** 
    ...
    * @return A list of matching call expressions as strings
    */
  ...
  /** 
    ...
    * @param cpg The Code Property Graph
    * @param q The query to execute
    * @return A list of matching literal values as strings
    */
  ...
  /** 
    ...
    * @param cpg The Code Property Graph
    * @param q The query to execute
    * @return A list of matching method names as strings
    */
