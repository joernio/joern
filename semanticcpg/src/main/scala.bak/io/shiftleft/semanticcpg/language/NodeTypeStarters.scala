...
import io.shiftleft.codepropertygraph.generated.v2.v2.CpgGeneratedNodeStarters
...
class NodeTypeStarters(cpg: Cpg) extends CpgGeneratedNodeStarters {

  /** Traverse to all nodes.
    */
  // @Doc(info = "All nodes of the graph")
  override def all: Iterator[StoredNode] =
    // TODO implement in flatgraph
    ???
