...
//          println("YYY8")
        ...
        val ret = results(newPath, sources, table, callSiteStack)
//        if (DebugMode.enabled) println("YYY9")
        ret
      }
    }
...
//        if (DebugMode.enabled) println("YYY11")
...
//        if (DebugMode.enabled) println("YYY12")
...
//        if (DebugMode.enabled) println("YYY13")
