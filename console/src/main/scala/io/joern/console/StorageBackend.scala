...
/** like the default ammonite folder storage (which gives us e.g. command history), but without the CodePredef error
  * when using multiple ocular installations (see https://github.com/ShiftLeftSecurity/product/issues/2082)
  */
