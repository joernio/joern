...
ocular> cpg.call.name("exit").newTagNode("MY_KIND_OF_EXIT").store 
...
ocular> cpg.tag.name("MY_KIND_OF_EXIT").l 
...
ocular> cpg.tag.name("MY_KIND_OF_EXIT").call.code.l 
...
```java
ocular> cpg.call.name("exit").newTagNodePai("MY_OTHER_KIND_OF_EXIT", "MY_VALUE").store 
