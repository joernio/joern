...
class PCodeProcessor extends Processor {
  override def getInstructions: HashMap[String, String] =
    HashMap(
      ...
      "BOOL_OR" -> "<operator>.TODO",
      "BOOL_XOR" -> "<operator>.TODO",
      "BRANCH" -> "<operator>.TODO",
      "BRANCHIND" -> "<operator>.TODO",
      "CALL" -> "<operator>.TODO",
      "CALLIND" -> "<operator>.TODO",
