...
class MipsProcessor extends Processor {
  override def getInstructions: HashMap[String, String] =
    HashMap(
      ...
      "_lw" -> "<operator>.loadWord",
      "_lwc1" -> "<operator>.loadWord",
      "_lwl" -> "<operator>.loadWord",
      "_lwr" -> "<operator>.loadWord",
      ...
      "lw" -> "<operator>.loadWord",
      "lwc1" -> "<operator>.loadWord",
      "lwl" -> "<operator>.loadWord",
      "lwr" -> "<operator>.loadWord",
      "lwxc1" -> "<operator>.loadWord",
      "madd" -> "<operator>.incBy",
      ...
      "subu" -> "<operator>.decBy",
      "sw" -> "<operator>.storeWord",
      "swc1" -> "<operator>.TODO",
      "swl" -> "<operator>.storeWord",
      "swr" -> "<operator>.TODO",
      "sync" -> "<operator>.TODO",
