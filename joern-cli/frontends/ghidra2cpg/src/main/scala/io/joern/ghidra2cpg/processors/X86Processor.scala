...
class X86Processor extends Processor {
  override def getInstructions: HashMap[String, String] =
    HashMap(
      ...
      "COMISS"    -> "<operator>.compare",
      "CQO"       -> "<operator>.assignment",
      "CS"        -> "<operator>.assignment",
      "CVTSI2SD"  -> "<operator>.assignment",
      "CVTSI2SS"  -> "<operator>.assignment",
      "CVTTSS2SI" -> "<operator>.assignment",
      ...
      "FADD"      -> "<operator>.incBy",
      "STOSQ.REP" -> "<operator>.assigment",
      "FCOMI"     -> "<operator>.compare",
      "FCOMIP"    -> "<operator>.compare",
      "FDIV"      -> "<operator>.division",
      "FDIVP"     -> "<operator>.division",
      "FDIVP"     -> "<operator>.division",
      "FDIVRP"    -> "<operator>.division",
      "FILD"      -> "<operator>.assignment",
      "FISTP"     -> "<operator>.assignment",
      "FLD"       -> "<operator>.assignment",
      "FLDCW"     -> "<operator>.assignment",
      "FMUL"      -> "<operator>.multiplication",
      "FMULP"     -> "<operator>.multiplication",
      "FNSTCW"    -> "<operator>.assignment",
      "FSTP"      -> "<operator>.assignment",
      "FSUBR"     -> "<operator>.subtraction",
      "FUCOMI"    -> "<operator>.assignment",
      "FUCOMIP"   -> "<operator>.assignment",
      "FXCH"      -> "<operator>.exchange",
      "HLT"       -> "<operator>.NOP",
