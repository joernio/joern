...
object py2cpg extends SbtModule with ScalafmtModule {
  ...
  override def ivyDeps = Agg(
    ivy"io.shiftleft::codepropertygraph:1.3.201".exclude("io.shiftleft" -> "codepropertygraph-domain-classes_2.13"),
    ivy"io.shiftleft::semanticcpg:1.3.201",
    ivy"io.shiftleft:semanticcpg-ext:1.4.405",
    ivy"io.shiftleft:codescience-domain-classes:1.4.405",
