...
class BooleanOperationsTests extends JavaSrcCode2CpgFixture {
  ...
  "should contain a call node for the equals operator" in {
    ...
    val List(a: Literal, b: Literal) = op.astOut.isLiteral.l
    a.code shouldBe "1"
    b.code shouldBe "2"
  }
  ...
  "should contain a call node for the notEquals operator" in {
    ...
    val List(a: Literal, b: Literal) = op.astOut.isLiteral
    a.code shouldBe "3"
    b.code shouldBe "4"
  }
  ...
  "should contain a call node for the logicalAnd operator" in {
    ...
    val List(a: Identifier, b: Identifier) = op.astOut.isIdentifier.l
    a.name shouldBe "a"
    b.name shouldBe "b"
  }
  ...
  "should contain a call node for the logicalNot operator" in {
    ...
    val List(a: Identifier) = op.astOut.isIdentifier.l
    a.name shouldBe "h"
  }
}
