...
class CallTests extends JavaSrcCodeToCpgFixture {
  ...
  override val code: String =
    """
      ...
      |}
      |""".stripMargin
//  (null,METHOD,int add(int x, int y))
//  (0,METHOD_PARAMETER_IN,this)
//  (1,METHOD_PARAMETER_IN,int x)
//  (2,METHOD_PARAMETER_IN,int y)
//  (3,BLOCK,null)
//  (1,RETURN,return x + y;)
//  (2,CALL,x + y)
//  (1,IDENTIFIER,x)
...
//  (null,METHOD,int main(int argc, char argv))
//  (0,METHOD_PARAMETER_IN,this)
//  (1,METHOD_PARAMETER_IN,int argc)
//  (2,METHOD_PARAMETER_IN,char argv)
//  (3,BLOCK,null)
//  (1,RETURN,return add(argc, 3);)
//  (2,CALL,this.add(argc, 3))
//  (0,IDENTIFIER,this)
//  (1,IDENTIFIER,argc)
//  (2,LITERAL,3)
//  (null,MODIFIER,VIRTUAL)
//  (null,METHOD_RETURN,int)
//  (null,METHOD,int bar(int argc))
//  (0,METHOD_PARAMETER_IN,this)
//  (1,METHOD_PARAMETER_IN,int argc)
//  (2,BLOCK,null)
//  (1,CALL,foo(argc))
...
//  (null,MODIFIER,VIRTUAL)
//  (null,METHOD_RETURN,int)
//  (null,METHOD,public static String staticCall(String s))
//  (1,METHOD_PARAMETER_IN,String s)
//  (2,BLOCK,null)
//  (1,RETURN,return s;)
//  (2,IDENTIFIER,s)
//  (null,METHOD_RETURN,java.lang.String)
//  (null,METHOD,public String myMethod(String s))
//  (0,METHOD_PARAMETER_IN,this)
//  (1,METHOD_PARAMETER_IN,String s)
//  (2,BLOCK,null)
//  (1,RETURN,return s;)
...
//  (null,MODIFIER,VIRTUAL)
//  (null,METHOD_RETURN,java.lang.String)
//  (null,METHOD,public static void staticMethod())
//  (1,BLOCK,null)
//  (null,METHOD_RETURN,void)
//  (null,METHOD,public String foo(MyObject myObj))
//  (0,METHOD_PARAMETER_IN,this)
//  (1,METHOD_PARAMETER_IN,MyObject myObj)
//  (2,BLOCK,null)
//  (1,RETURN,return myObj.myMethod("Hello, world!");)
//  (2,CALL,myObj.myMethod("Hello, world!"))
//  (0,IDENTIFIER,myObj)
//  (1,LITERAL,"Hello, world!")
//  (null,MODIFIER,VIRTUAL)
//  (null,METHOD_RETURN,java.lang.String)
//  (null,METHOD,public void bar())
//  (0,METHOD_PARAMETER_IN,this)
//  (1,BLOCK,null)
//  (1,CALL,this.foo(obj))
//  (0,IDENTIFIER,this)
//  (1,CALL,obj)
//  (1,IDENTIFIER,this)
//  (2,FIELD_IDENTIFIER,obj)
//  (null,MODIFIER,VIRTUAL)
//  (null,METHOD_RETURN,void)
//  (null,METHOD,public void baz())
//  (0,METHOD_PARAMETER_IN,this)
//  (1,BLOCK,null)
//  (1,CALL,this.foo(obj))
//  (0,IDENTIFIER,this)
...
//  (null,MODIFIER,VIRTUAL)
//  (null,METHOD_RETURN,void)
//  (null,METHOD,public void qux())
//  (0,METHOD_PARAMETER_IN,this)
//  (1,BLOCK,null)
//  (1,CALL,staticMethod())
//  (null,MODIFIER,VIRTUAL)
//  (null,METHOD_RETURN,void)
//  (null,METHOD,public void quux())
//  (0,METHOD_PARAMETER_IN,this)
//  (1,BLOCK,null)
//  (1,CALL,this.bar())
//  (0,IDENTIFIER,this)
