...
import com.github.javaparser.ast.body.{BodyDeclaration, CallableDeclaration, ConstructorDeclaration, EnumConstantDeclaration, MethodDeclaration, Parameter, TypeDeclaration, VariableDeclarator}
