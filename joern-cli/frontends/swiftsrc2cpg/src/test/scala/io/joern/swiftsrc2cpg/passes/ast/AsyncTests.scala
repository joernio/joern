...
class AsyncTests extends AstSwiftSrc2CpgSuite {
  ...
  "AsyncTests" should {
    ...
    "testAsync3" in {
      ...
      asyncGlobal3.fullName shouldBe "Test0.swift:<global>:asyncGlobal3"
      val List(fn) = asyncGlobal3.parameter.l
      fn.name shouldBe "fn"
      fn.typeFullName shouldBe "Test0.swift:<global>:asyncGlobal3:_anon_cdecl_0"
      val List(t) = cpg.typeDecl.fullNameExact("Test0.swift:<global>:asyncGlobal3:_anon_cdecl_0").l
    ...
    "testAsync4" in {
      ...
      asyncGlobal4.fullName shouldBe "Test0.swift:<global>:asyncGlobal4"
    ...
    "testAsync6" in {
      ...
      asyncGlobal6.fullName shouldBe "Test0.swift:<global>:asyncGlobal6"
    ...
    "testAsync10b" in {
      ...
      f2.aliasTypeFullName shouldBe Option("Test0.swift:<global>:_anon_cdecl_0")
      cpg.typeDecl.fullNameExact("Test0.swift:<global>:_anon_cdecl_0").size shouldBe 1
    }
    ...
    "testAsync12" in {
      ...
      await.fullName shouldBe "Test0.swift:<global>:MyFuture:await"
    ...
    "testAsync14" in {
      ...
      getIntSomeday.fullName shouldBe "Test0.swift:<global>:getIntSomeday"
    ...
    "testAsync16" in {
      ...
      asyncIncorrectly.fullName shouldBe "Test0.swift:<global>:asyncIncorrectly"
    }
