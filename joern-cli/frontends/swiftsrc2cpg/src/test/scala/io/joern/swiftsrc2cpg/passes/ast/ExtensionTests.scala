...
class ExtensionTests extends AbstractPassTest {
  ...
  private def testExtension(cpg: Cpg): Unit = {
    ...
    bConstructor.fullName shouldBe "code.swift:<global>:B:init"
    ...
    typeDeclFoo.inheritsFromTypeFullName.l shouldBe List("Bar", "SomeProtocol", "AnotherProtocol")
