...
class AsyncSyntaxTests extends SwiftSrc2CpgSuite {
  ...
  "AsyncSyntaxTests" should {
    ...
    "testAsyncSyntax2" in {
      ...
      f1.aliasTypeFullName shouldBe Option("Test0.swift:<global>.<Swift.Function>0")
      ...
      f2.aliasTypeFullName shouldBe Option("Test0.swift:<global>.<Swift.Function>1")
      cpg.typeDecl.fullNameExact("Test0.swift:<global>.<Swift.Function>1").size shouldBe 1

      f3.name shouldBe "AsyncFunc3"
      f3.fullName shouldBe "Test0.swift:<global>.AsyncFunc3"
      f3.aliasTypeFullName shouldBe Option("Test0.swift:<global>.<Swift.Function>2")
