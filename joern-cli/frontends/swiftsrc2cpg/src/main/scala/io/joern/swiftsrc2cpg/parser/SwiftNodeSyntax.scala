...
// Generated: July 9, 2026 at 8:25:38 AM GMT+2
...
object SwiftNodeSyntax {
  ...
  case class ABIAttributeArgumentsSyntax(json: Value) extends Syntax {
    lazy val provider
      : AssociatedTypeDeclSyntax | DeinitializerDeclSyntax | EnumCaseDeclSyntax | FunctionDeclSyntax | InitializerDeclSyntax | MissingDeclSyntax | SubscriptDeclSyntax | TypeAliasDeclSyntax | VariableDeclSyntax =
  ...
  case class AccessorBlockSyntax(json: Value) extends Syntax with Braced {
    ...
    lazy val accessors: AccessorDeclListSyntax | CodeBlockItemListSyntax =
  ...
  case class AccessorDeclListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[AccessorDeclSyntax] =
  ...
  case class AccessorEffectSpecifiersSyntax(json: Value) extends Syntax with EffectSpecifiers {
    lazy val asyncSpecifier: Option[SwiftToken] =
  ...
  case class ActorDeclSyntax(json: Value)
    ...
    lazy val actorKeyword: SwiftToken = createSwiftNode(_childrenMap("actorKeyword")).asInstanceOf[SwiftToken]
    lazy val name: SwiftToken         = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    ...
    lazy val inheritanceClause: Option[InheritanceClauseSyntax] =
      _childrenMap.get("inheritanceClause").map(c => createSwiftNode(c).asInstanceOf[InheritanceClauseSyntax])
    lazy val genericWhereClause: Option[GenericWhereClauseSyntax] =
      _childrenMap.get("genericWhereClause").map(c => createSwiftNode(c).asInstanceOf[GenericWhereClauseSyntax])
    lazy val memberBlock: MemberBlockSyntax =
      createSwiftNode(_childrenMap("memberBlock")).asInstanceOf[MemberBlockSyntax]
  }
  ...
  case class ArrayElementListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[ArrayElementSyntax] =
  ...
  case class ArrayTypeSyntax(json: Value) extends TypeSyntax {
    lazy val leftSquare: SwiftToken  = createSwiftNode(_childrenMap("leftSquare")).asInstanceOf[SwiftToken]
    lazy val element: TypeSyntax     = createSwiftNode(_childrenMap("element")).asInstanceOf[TypeSyntax]
    lazy val rightSquare: SwiftToken = createSwiftNode(_childrenMap("rightSquare")).asInstanceOf[SwiftToken]
  }
  ...
  case class ArrowExprSyntax(json: Value) extends ExprSyntax {
    lazy val effectSpecifiers: Option[TypeEffectSpecifiersSyntax] =
      _childrenMap.get("effectSpecifiers").map(c => createSwiftNode(c).asInstanceOf[TypeEffectSpecifiersSyntax])
    lazy val arrow: SwiftToken = createSwiftNode(_childrenMap("arrow")).asInstanceOf[SwiftToken]
  }
  ...
  case class AsExprSyntax(json: Value) extends ExprSyntax {
    lazy val expression: ExprSyntax = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
    lazy val asKeyword: SwiftToken  = createSwiftNode(_childrenMap("asKeyword")).asInstanceOf[SwiftToken]
    lazy val questionOrExclamationMark: Option[SwiftToken] =
  ...
  case class AssociatedTypeDeclSyntax(json: Value)
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val associatedtypeKeyword: SwiftToken =
      createSwiftNode(_childrenMap("associatedtypeKeyword")).asInstanceOf[SwiftToken]
    lazy val name: SwiftToken = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    lazy val inheritanceClause: Option[InheritanceClauseSyntax] =
      _childrenMap.get("inheritanceClause").map(c => createSwiftNode(c).asInstanceOf[InheritanceClauseSyntax])
    lazy val initializer: Option[TypeInitializerClauseSyntax] =
  ...
  case class AttributeListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[AttributeSyntax | IfConfigDeclSyntax] = json("children").arr.iterator
  ...
  case class AttributeSyntax(json: Value) extends Syntax {
    ...
    lazy val rightParen: Option[SwiftToken] =
  ...
  case class AttributedTypeSyntax(json: Value) extends TypeSyntax with WithAttributes {
    lazy val specifiers: TypeSpecifierListSyntax =
      createSwiftNode(_childrenMap("specifiers")).asInstanceOf[TypeSpecifierListSyntax]
    lazy val attributes: AttributeListSyntax =
      createSwiftNode(_childrenMap("attributes")).asInstanceOf[AttributeListSyntax]
    lazy val lateSpecifiers: TypeSpecifierListSyntax =
      createSwiftNode(_childrenMap("lateSpecifiers")).asInstanceOf[TypeSpecifierListSyntax]
    lazy val baseType: TypeSyntax = createSwiftNode(_childrenMap("baseType")).asInstanceOf[TypeSyntax]
  }
  ...
  case class AvailabilityArgumentListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[AvailabilityArgumentSyntax] =
  ...
  case class AvailabilityArgumentSyntax(json: Value) extends Syntax with WithTrailingComma {
    lazy val argument: SwiftToken | PlatformVersionSyntax | AvailabilityLabeledArgumentSyntax = createSwiftNode(
  ...
  case class AvailabilityConditionSyntax(json: Value) extends Syntax {
    lazy val availabilityKeyword: SwiftToken =
      createSwiftNode(_childrenMap("availabilityKeyword")).asInstanceOf[SwiftToken]
    lazy val leftParen: SwiftToken = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    lazy val availabilityArguments: AvailabilityArgumentListSyntax = createSwiftNode(
      _childrenMap("availabilityArguments")
  ...
  case class AvailabilityLabeledArgumentSyntax(json: Value) extends Syntax {
    ...
    lazy val value: SimpleStringLiteralExprSyntax | VersionTupleSyntax =
  ...
  case class AwaitExprSyntax(json: Value) extends ExprSyntax {
    lazy val awaitKeyword: SwiftToken = createSwiftNode(_childrenMap("awaitKeyword")).asInstanceOf[SwiftToken]
    lazy val expression: ExprSyntax   = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
  }
  ...
  case class BackDeployedAttributeArgumentsSyntax(json: Value) extends Syntax {
    lazy val beforeLabel: SwiftToken = createSwiftNode(_childrenMap("beforeLabel")).asInstanceOf[SwiftToken]
    lazy val colon: SwiftToken       = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
  ...
  case class BinaryOperatorExprSyntax(json: Value) extends ExprSyntax {
    lazy val operator: SwiftToken = createSwiftNode(_childrenMap("operator")).asInstanceOf[SwiftToken]
  }
  ...
  case class BooleanLiteralExprSyntax(json: Value) extends ExprSyntax {
    lazy val literal: SwiftToken = createSwiftNode(_childrenMap("literal")).asInstanceOf[SwiftToken]
  }
  ...
  case class BorrowExprSyntax(json: Value) extends ExprSyntax {
    lazy val borrowKeyword: SwiftToken = createSwiftNode(_childrenMap("borrowKeyword")).asInstanceOf[SwiftToken]
    lazy val expression: ExprSyntax    = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
  }
  ...
  case class BreakStmtSyntax(json: Value) extends StmtSyntax {
    ...
    lazy val label: Option[SwiftToken] = _childrenMap.get("label").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
  }
  ...
  case class _CanImportExprSyntax(json: Value) extends ExprSyntax {
    lazy val canImportKeyword: SwiftToken = createSwiftNode(_childrenMap("canImportKeyword")).asInstanceOf[SwiftToken]
    lazy val leftParen: SwiftToken        = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    lazy val importPath: SwiftToken       = createSwiftNode(_childrenMap("importPath")).asInstanceOf[SwiftToken]
    lazy val versionInfo: Option[_CanImportVersionInfoSyntax] =
  ...
  case class _CanImportVersionInfoSyntax(json: Value) extends ExprSyntax {
    ...
    lazy val label: SwiftToken           = createSwiftNode(_childrenMap("label")).asInstanceOf[SwiftToken]
    lazy val colon: SwiftToken           = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
    lazy val version: VersionTupleSyntax = createSwiftNode(_childrenMap("version")).asInstanceOf[VersionTupleSyntax]
  }
  ...
  case class CatchClauseListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[CatchClauseSyntax] =
  ...
  case class CatchItemListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[CatchItemSyntax] =
  ...
  case class CatchItemSyntax(json: Value) extends Syntax with WithTrailingComma {
    lazy val pattern: Option[PatternSyntax] =
      _childrenMap.get("pattern").map(c => createSwiftNode(c).asInstanceOf[PatternSyntax])
    lazy val whereClause: Option[WhereClauseSyntax] =
  ...
  case class ClassDeclSyntax(json: Value)
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val classKeyword: SwiftToken = createSwiftNode(_childrenMap("classKeyword")).asInstanceOf[SwiftToken]
    lazy val name: SwiftToken         = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    lazy val genericParameterClause: Option[GenericParameterClauseSyntax] =
      _childrenMap.get("genericParameterClause").map(c => createSwiftNode(c).asInstanceOf[GenericParameterClauseSyntax])
    lazy val inheritanceClause: Option[InheritanceClauseSyntax] =
  ...
  case class ClosureCaptureListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[ClosureCaptureSyntax] =
  ...
  case class ClosureCaptureSpecifierSyntax(json: Value) extends Syntax {
    ...
    lazy val detail: Option[SwiftToken] =
      _childrenMap.get("detail").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val rightParen: Option[SwiftToken] =
      _childrenMap.get("rightParen").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
  }
  ...
  case class ClosureCaptureSyntax(json: Value) extends Syntax with WithTrailingComma {
    lazy val specifier: Option[ClosureCaptureSpecifierSyntax] =
      _childrenMap.get("specifier").map(c => createSwiftNode(c).asInstanceOf[ClosureCaptureSpecifierSyntax])
    lazy val name: SwiftToken = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    lazy val initializer: Option[InitializerClauseSyntax] =
  ...
  case class ClosureExprSyntax(json: Value) extends ExprSyntax with Braced with WithStatements {
    lazy val leftBrace: SwiftToken = createSwiftNode(_childrenMap("leftBrace")).asInstanceOf[SwiftToken]
    lazy val signature: Option[ClosureSignatureSyntax] =
  ...
  case class ClosureParameterClauseSyntax(json: Value) extends Syntax with Parenthesized {
    lazy val leftParen: SwiftToken = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    lazy val parameters: ClosureParameterListSyntax =
  ...
  case class ClosureParameterListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[ClosureParameterSyntax] =
  ...
  case class ClosureParameterSyntax(json: Value)
    ...
    lazy val colon: Option[SwiftToken] = _childrenMap.get("colon").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val `type`: Option[TypeSyntax] = _childrenMap.get("type").map(c => createSwiftNode(c).asInstanceOf[TypeSyntax])
  ...
  case class ClosureShorthandParameterListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[ClosureShorthandParameterSyntax] =
  ...
  case class ClosureSignatureSyntax(json: Value) extends Syntax with WithAttributes {
    lazy val attributes: AttributeListSyntax =
      createSwiftNode(_childrenMap("attributes")).asInstanceOf[AttributeListSyntax]
    lazy val capture: Option[ClosureCaptureClauseSyntax] =
      _childrenMap.get("capture").map(c => createSwiftNode(c).asInstanceOf[ClosureCaptureClauseSyntax])
    lazy val parameterClause: Option[ClosureShorthandParameterListSyntax | ClosureParameterClauseSyntax] = _childrenMap
      .get("parameterClause")
      .map(c => createSwiftNode(c).asInstanceOf[ClosureShorthandParameterListSyntax | ClosureParameterClauseSyntax])
    lazy val effectSpecifiers: Option[TypeEffectSpecifiersSyntax] =
      _childrenMap.get("effectSpecifiers").map(c => createSwiftNode(c).asInstanceOf[TypeEffectSpecifiersSyntax])
    lazy val returnClause: Option[ReturnClauseSyntax] =
      _childrenMap.get("returnClause").map(c => createSwiftNode(c).asInstanceOf[ReturnClauseSyntax])
    lazy val inKeyword: SwiftToken = createSwiftNode(_childrenMap("inKeyword")).asInstanceOf[SwiftToken]
  }
  ...
  case class CodeBlockItemListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[CodeBlockItemSyntax] =
  ...
  case class CodeBlockItemSyntax(json: Value) extends Syntax {
    lazy val item: DeclSyntax | StmtSyntax | ExprSyntax =
  ...
  case class CompositionTypeElementListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[CompositionTypeElementSyntax] =
  ...
  case class CompositionTypeSyntax(json: Value) extends TypeSyntax {
    lazy val elements: CompositionTypeElementListSyntax =
  ...
  case class ConditionElementListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[ConditionElementSyntax] =
  ...
  case class ConditionElementSyntax(json: Value) extends Syntax with WithTrailingComma {
    lazy val condition
      ...
      createSwiftNode(_childrenMap("condition")).asInstanceOf[
        ExprSyntax | AvailabilityConditionSyntax | MatchingPatternConditionSyntax | OptionalBindingConditionSyntax
      ]
    lazy val trailingComma: Option[SwiftToken] =
      _childrenMap.get("trailingComma").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
  ...
  case class ConformanceRequirementSyntax(json: Value) extends Syntax {
    lazy val leftType: TypeSyntax  = createSwiftNode(_childrenMap("leftType")).asInstanceOf[TypeSyntax]
    lazy val colon: SwiftToken     = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
    lazy val rightType: TypeSyntax = createSwiftNode(_childrenMap("rightType")).asInstanceOf[TypeSyntax]
  }
  ...
  case class ConsumeExprSyntax(json: Value) extends ExprSyntax {
    lazy val consumeKeyword: SwiftToken = createSwiftNode(_childrenMap("consumeKeyword")).asInstanceOf[SwiftToken]
    lazy val expression: ExprSyntax     = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
  }
  ...
  case class CopyExprSyntax(json: Value) extends ExprSyntax {
    lazy val copyKeyword: SwiftToken = createSwiftNode(_childrenMap("copyKeyword")).asInstanceOf[SwiftToken]
    lazy val expression: ExprSyntax  = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
  }
  ...
  case class DeclModifierDetailSyntax(json: Value) extends Syntax with Parenthesized {
    lazy val leftParen: SwiftToken  = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    lazy val detail: SwiftToken     = createSwiftNode(_childrenMap("detail")).asInstanceOf[SwiftToken]
    lazy val rightParen: SwiftToken = createSwiftNode(_childrenMap("rightParen")).asInstanceOf[SwiftToken]
  }
  ...
  case class DeclModifierListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[DeclModifierSyntax] =
  ...
  case class DeclNameArgumentListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[DeclNameArgumentSyntax] =
  ...
  case class DeclNameArgumentSyntax(json: Value) extends Syntax {
    lazy val name: TokenSyntax = createSwiftNode(_childrenMap("name")).asInstanceOf[TokenSyntax]
    lazy val colon: SwiftToken = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
  }
  ...
  case class DeclReferenceExprSyntax(json: Value) extends ExprSyntax {
    lazy val moduleSelector: Option[ModuleSelectorSyntax] =
      _childrenMap.get("moduleSelector").map(c => createSwiftNode(c).asInstanceOf[ModuleSelectorSyntax])
    lazy val baseName: SwiftToken = createSwiftNode(_childrenMap("baseName")).asInstanceOf[SwiftToken]
    lazy val argumentNames: Option[DeclNameArgumentsSyntax] =
  ...
  case class DeferStmtSyntax(json: Value) extends StmtSyntax with WithCodeBlock {
    lazy val deferKeyword: SwiftToken = createSwiftNode(_childrenMap("deferKeyword")).asInstanceOf[SwiftToken]
    lazy val body: CodeBlockSyntax    = createSwiftNode(_childrenMap("body")).asInstanceOf[CodeBlockSyntax]
  }
  ...
  case class DeinitializerDeclSyntax(json: Value)
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val deinitKeyword: SwiftToken = createSwiftNode(_childrenMap("deinitKeyword")).asInstanceOf[SwiftToken]
    lazy val effectSpecifiers: Option[DeinitializerEffectSpecifiersSyntax] = _childrenMap
  ...
  case class DerivativeAttributeArgumentsSyntax(json: Value) extends Syntax {
    ...
    lazy val period: Option[SwiftToken] =
      _childrenMap.get("period").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    ...
    lazy val comma: Option[SwiftToken] = _childrenMap.get("comma").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val arguments: Option[DifferentiabilityWithRespectToArgumentSyntax] = _childrenMap
      .get("arguments")
  ...
  case class DesignatedTypeListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[DesignatedTypeSyntax] =
  ...
  case class DesignatedTypeSyntax(json: Value) extends Syntax {
    lazy val leadingComma: SwiftToken = createSwiftNode(_childrenMap("leadingComma")).asInstanceOf[SwiftToken]
    lazy val name: TokenSyntax        = createSwiftNode(_childrenMap("name")).asInstanceOf[TokenSyntax]
  }
  ...
  case class DictionaryElementListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[DictionaryElementSyntax] =
  ...
  case class DictionaryExprSyntax(json: Value) extends ExprSyntax {
    lazy val leftSquare: SwiftToken = createSwiftNode(_childrenMap("leftSquare")).asInstanceOf[SwiftToken]
    lazy val content: SwiftToken | DictionaryElementListSyntax =
  ...
  case class DictionaryTypeSyntax(json: Value) extends TypeSyntax {
    lazy val leftSquare: SwiftToken  = createSwiftNode(_childrenMap("leftSquare")).asInstanceOf[SwiftToken]
    lazy val key: TypeSyntax         = createSwiftNode(_childrenMap("key")).asInstanceOf[TypeSyntax]
    lazy val colon: SwiftToken       = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
    lazy val value: TypeSyntax       = createSwiftNode(_childrenMap("value")).asInstanceOf[TypeSyntax]
    lazy val rightSquare: SwiftToken = createSwiftNode(_childrenMap("rightSquare")).asInstanceOf[SwiftToken]
  }
  ...
  case class DifferentiabilityArgumentListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[DifferentiabilityArgumentSyntax] =
  ...
  case class DifferentiabilityArgumentsSyntax(json: Value) extends Syntax {
    lazy val leftParen: SwiftToken = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    lazy val arguments: DifferentiabilityArgumentListSyntax =
  ...
  case class DifferentiabilityWithRespectToArgumentSyntax(json: Value) extends Syntax {
    lazy val wrtLabel: SwiftToken = createSwiftNode(_childrenMap("wrtLabel")).asInstanceOf[SwiftToken]
    lazy val colon: SwiftToken    = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
    lazy val arguments: DifferentiabilityArgumentSyntax | DifferentiabilityArgumentsSyntax = createSwiftNode(
  ...
  case class DiscardAssignmentExprSyntax(json: Value) extends ExprSyntax {
    lazy val wildcard: SwiftToken = createSwiftNode(_childrenMap("wildcard")).asInstanceOf[SwiftToken]
  }
  ...
  case class DiscardStmtSyntax(json: Value) extends StmtSyntax {
    lazy val discardKeyword: SwiftToken = createSwiftNode(_childrenMap("discardKeyword")).asInstanceOf[SwiftToken]
    lazy val expression: ExprSyntax     = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
  }
  ...
  case class DocumentationAttributeArgumentListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[DocumentationAttributeArgumentSyntax] = json("children").arr.iterator
  ...
  case class DocumentationAttributeArgumentSyntax(json: Value) extends Syntax with WithTrailingComma {
    lazy val label: SwiftToken = createSwiftNode(_childrenMap("label")).asInstanceOf[SwiftToken]
    lazy val colon: SwiftToken = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
    lazy val value: SwiftToken | StringLiteralExprSyntax =
  ...
  case class EditorPlaceholderDeclSyntax(json: Value) extends DeclSyntax with WithAttributes with WithModifiers {
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val placeholder: SwiftToken = createSwiftNode(_childrenMap("placeholder")).asInstanceOf[SwiftToken]
  }
  ...
  case class EffectsAttributeArgumentListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[TokenSyntax] =
  ...
  case class EnumCaseElementListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[EnumCaseElementSyntax] =
  ...
  case class EnumCaseElementSyntax(json: Value) extends Syntax with WithTrailingComma {
    lazy val name: SwiftToken = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    lazy val parameterClause: Option[EnumCaseParameterClauseSyntax] =
      _childrenMap.get("parameterClause").map(c => createSwiftNode(c).asInstanceOf[EnumCaseParameterClauseSyntax])
    lazy val rawValue: Option[InitializerClauseSyntax] =
  ...
  case class EnumCaseParameterClauseSyntax(json: Value) extends Syntax with Parenthesized {
    lazy val leftParen: SwiftToken = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    lazy val parameters: EnumCaseParameterListSyntax =
  ...
  case class EnumCaseParameterListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[EnumCaseParameterSyntax] =
  ...
  case class EnumCaseParameterSyntax(json: Value) extends Syntax with WithTrailingComma with WithModifiers {
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val firstName: Option[SwiftToken] =
  ...
  case class EnumDeclSyntax(json: Value)
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val enumKeyword: SwiftToken = createSwiftNode(_childrenMap("enumKeyword")).asInstanceOf[SwiftToken]
    lazy val name: SwiftToken        = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    lazy val genericParameterClause: Option[GenericParameterClauseSyntax] =
      _childrenMap.get("genericParameterClause").map(c => createSwiftNode(c).asInstanceOf[GenericParameterClauseSyntax])
    lazy val inheritanceClause: Option[InheritanceClauseSyntax] =
  ...
  case class ExprListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[ExprSyntax] =
  ...
  case class ExpressionSegmentSyntax(json: Value) extends Syntax with Parenthesized {
    ...
    lazy val pounds: Option[SwiftToken] =
      _childrenMap.get("pounds").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val leftParen: SwiftToken = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
  ...
  case class ExtensionDeclSyntax(json: Value) extends DeclSyntax with DeclGroup with WithAttributes with WithModifiers {
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val extensionKeyword: SwiftToken = createSwiftNode(_childrenMap("extensionKeyword")).asInstanceOf[SwiftToken]
    lazy val extendedType: TypeSyntax     = createSwiftNode(_childrenMap("extendedType")).asInstanceOf[TypeSyntax]
    lazy val inheritanceClause: Option[InheritanceClauseSyntax] =
      _childrenMap.get("inheritanceClause").map(c => createSwiftNode(c).asInstanceOf[InheritanceClauseSyntax])
    lazy val genericWhereClause: Option[GenericWhereClauseSyntax] =
      _childrenMap.get("genericWhereClause").map(c => createSwiftNode(c).asInstanceOf[GenericWhereClauseSyntax])
  ...
  case class FallThroughStmtSyntax(json: Value) extends StmtSyntax {
    lazy val fallthroughKeyword: SwiftToken =
      createSwiftNode(_childrenMap("fallthroughKeyword")).asInstanceOf[SwiftToken]
  }
  ...
  case class ForStmtSyntax(json: Value) extends StmtSyntax with WithCodeBlock {
    ...
    lazy val unsafeKeyword: Option[SwiftToken] =
      _childrenMap.get("unsafeKeyword").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val caseKeyword: Option[SwiftToken] =
    ...
    lazy val typeAnnotation: Option[TypeAnnotationSyntax] =
      _childrenMap.get("typeAnnotation").map(c => createSwiftNode(c).asInstanceOf[TypeAnnotationSyntax])
    lazy val inKeyword: SwiftToken = createSwiftNode(_childrenMap("inKeyword")).asInstanceOf[SwiftToken]
    lazy val sequence: ExprSyntax  = createSwiftNode(_childrenMap("sequence")).asInstanceOf[ExprSyntax]
    lazy val whereClause: Option[WhereClauseSyntax] =
      _childrenMap.get("whereClause").map(c => createSwiftNode(c).asInstanceOf[WhereClauseSyntax])
    lazy val body: CodeBlockSyntax = createSwiftNode(_childrenMap("body")).asInstanceOf[CodeBlockSyntax]
  }
  ...
  case class ForceUnwrapExprSyntax(json: Value) extends ExprSyntax {
    lazy val expression: ExprSyntax      = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
    lazy val exclamationMark: SwiftToken = createSwiftNode(_childrenMap("exclamationMark")).asInstanceOf[SwiftToken]
  }
  ...
  case class FunctionCallExprSyntax(json: Value) extends ExprSyntax {
    ...
    lazy val rightParen: Option[SwiftToken] =
      _childrenMap.get("rightParen").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val trailingClosure: Option[ClosureExprSyntax] =
      _childrenMap.get("trailingClosure").map(c => createSwiftNode(c).asInstanceOf[ClosureExprSyntax])
    lazy val additionalTrailingClosures: MultipleTrailingClosureElementListSyntax = createSwiftNode(
  ...
  case class FunctionDeclSyntax(json: Value)
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val funcKeyword: SwiftToken = createSwiftNode(_childrenMap("funcKeyword")).asInstanceOf[SwiftToken]
    lazy val name: SwiftToken        = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    lazy val genericParameterClause: Option[GenericParameterClauseSyntax] =
      _childrenMap.get("genericParameterClause").map(c => createSwiftNode(c).asInstanceOf[GenericParameterClauseSyntax])
    lazy val signature: FunctionSignatureSyntax =
  ...
  case class FunctionParameterClauseSyntax(json: Value) extends Syntax with Parenthesized {
    lazy val leftParen: SwiftToken = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    lazy val parameters: FunctionParameterListSyntax =
  ...
  case class FunctionParameterListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[FunctionParameterSyntax] =
  ...
  case class FunctionSignatureSyntax(json: Value) extends Syntax {
    lazy val parameterClause: FunctionParameterClauseSyntax =
      createSwiftNode(_childrenMap("parameterClause")).asInstanceOf[FunctionParameterClauseSyntax]
    lazy val effectSpecifiers: Option[FunctionEffectSpecifiersSyntax] =
  ...
  case class FunctionTypeSyntax(json: Value) extends TypeSyntax with Parenthesized {
    lazy val leftParen: SwiftToken = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    lazy val parameters: TupleTypeElementListSyntax =
      createSwiftNode(_childrenMap("parameters")).asInstanceOf[TupleTypeElementListSyntax]
    lazy val rightParen: SwiftToken = createSwiftNode(_childrenMap("rightParen")).asInstanceOf[SwiftToken]
    lazy val effectSpecifiers: Option[TypeEffectSpecifiersSyntax] =
      _childrenMap.get("effectSpecifiers").map(c => createSwiftNode(c).asInstanceOf[TypeEffectSpecifiersSyntax])
    lazy val returnClause: ReturnClauseSyntax =
  ...
  case class GenericArgumentListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[GenericArgumentSyntax] =
  ...
  case class GenericArgumentSyntax(json: Value) extends Syntax with WithTrailingComma {
    lazy val argument: TypeSyntax | ExprSyntax =
  ...
  case class GenericParameterClauseSyntax(json: Value) extends Syntax {
    lazy val leftAngle: SwiftToken = createSwiftNode(_childrenMap("leftAngle")).asInstanceOf[SwiftToken]
    lazy val parameters: GenericParameterListSyntax =
  ...
  case class GenericParameterListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[GenericParameterSyntax] =
  ...
  case class GenericRequirementListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[GenericRequirementSyntax] =
  ...
  case class GenericRequirementSyntax(json: Value) extends Syntax with WithTrailingComma {
    lazy val requirement: SameTypeRequirementSyntax | ConformanceRequirementSyntax | LayoutRequirementSyntax =
  ...
  case class GenericSpecializationExprSyntax(json: Value) extends ExprSyntax {
    lazy val expression: ExprSyntax = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
    lazy val genericArgumentClause: GenericArgumentClauseSyntax =
  ...
  case class GenericWhereClauseSyntax(json: Value) extends Syntax {
    lazy val whereKeyword: SwiftToken = createSwiftNode(_childrenMap("whereKeyword")).asInstanceOf[SwiftToken]
    lazy val requirements: GenericRequirementListSyntax =
  ...
  case class GuardStmtSyntax(json: Value) extends StmtSyntax with WithCodeBlock {
    lazy val guardKeyword: SwiftToken = createSwiftNode(_childrenMap("guardKeyword")).asInstanceOf[SwiftToken]
    ...
    lazy val elseKeyword: SwiftToken = createSwiftNode(_childrenMap("elseKeyword")).asInstanceOf[SwiftToken]
    lazy val body: CodeBlockSyntax   = createSwiftNode(_childrenMap("body")).asInstanceOf[CodeBlockSyntax]
  }
  ...
  case class IdentifierPatternSyntax(json: Value) extends PatternSyntax {
    lazy val identifier: SwiftToken = createSwiftNode(_childrenMap("identifier")).asInstanceOf[SwiftToken]
  }
  ...
  case class IdentifierTypeSyntax(json: Value) extends TypeSyntax {
    lazy val moduleSelector: Option[ModuleSelectorSyntax] =
      _childrenMap.get("moduleSelector").map(c => createSwiftNode(c).asInstanceOf[ModuleSelectorSyntax])
    lazy val name: SwiftToken = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    lazy val genericArgumentClause: Option[GenericArgumentClauseSyntax] =
  ...
  case class IfConfigClauseListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[IfConfigClauseSyntax] =
  ...
  case class IfConfigDeclSyntax(json: Value) extends DeclSyntax {
    lazy val clauses: IfConfigClauseListSyntax =
      createSwiftNode(_childrenMap("clauses")).asInstanceOf[IfConfigClauseListSyntax]
    lazy val poundEndif: SwiftToken = createSwiftNode(_childrenMap("poundEndif")).asInstanceOf[SwiftToken]
  }
  ...
  case class ImplicitlyUnwrappedOptionalTypeSyntax(json: Value) extends TypeSyntax {
    lazy val wrappedType: TypeSyntax     = createSwiftNode(_childrenMap("wrappedType")).asInstanceOf[TypeSyntax]
    lazy val exclamationMark: SwiftToken = createSwiftNode(_childrenMap("exclamationMark")).asInstanceOf[SwiftToken]
  }
  ...
  case class ImportDeclSyntax(json: Value) extends DeclSyntax with WithAttributes with WithModifiers {
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val importKeyword: SwiftToken = createSwiftNode(_childrenMap("importKeyword")).asInstanceOf[SwiftToken]
    lazy val importKindSpecifier: Option[SwiftToken] =
      _childrenMap.get("importKindSpecifier").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val path: ImportPathComponentListSyntax =
  ...
  case class ImportPathComponentListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[ImportPathComponentSyntax] =
  ...
  case class InOutExprSyntax(json: Value) extends ExprSyntax {
    lazy val ampersand: SwiftToken  = createSwiftNode(_childrenMap("ampersand")).asInstanceOf[SwiftToken]
    lazy val expression: ExprSyntax = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
  }
  ...
  case class InfixOperatorExprSyntax(json: Value) extends ExprSyntax {
    lazy val leftOperand: ExprSyntax  = createSwiftNode(_childrenMap("leftOperand")).asInstanceOf[ExprSyntax]
    lazy val operator: ExprSyntax     = createSwiftNode(_childrenMap("operator")).asInstanceOf[ExprSyntax]
    lazy val rightOperand: ExprSyntax = createSwiftNode(_childrenMap("rightOperand")).asInstanceOf[ExprSyntax]
  }
  ...
  case class InheritedTypeListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[InheritedTypeSyntax] =
  ...
  case class IsExprSyntax(json: Value) extends ExprSyntax {
    lazy val expression: ExprSyntax = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
    lazy val isKeyword: SwiftToken  = createSwiftNode(_childrenMap("isKeyword")).asInstanceOf[SwiftToken]
    lazy val `type`: TypeSyntax     = createSwiftNode(_childrenMap("type")).asInstanceOf[TypeSyntax]
  }
  ...
  case class KeyPathComponentListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[KeyPathComponentSyntax] =
  ...
  case class KeyPathComponentSyntax(json: Value) extends Syntax {
    lazy val period: Option[SwiftToken] =
      _childrenMap.get("period").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val component
      : KeyPathPropertyComponentSyntax | KeyPathMethodComponentSyntax | KeyPathSubscriptComponentSyntax | KeyPathOptionalComponentSyntax =
      createSwiftNode(_childrenMap("component")).asInstanceOf[
  ...
  case class KeyPathExprSyntax(json: Value) extends ExprSyntax {
    lazy val backslash: SwiftToken    = createSwiftNode(_childrenMap("backslash")).asInstanceOf[SwiftToken]
    lazy val root: Option[TypeSyntax] = _childrenMap.get("root").map(c => createSwiftNode(c).asInstanceOf[TypeSyntax])
  ...
  case class KeyPathOptionalComponentSyntax(json: Value) extends Syntax {
    lazy val questionOrExclamationMark: SwiftToken =
  ...
  case class LabeledExprListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[LabeledExprSyntax] =
  ...
  case class LabeledStmtSyntax(json: Value) extends StmtSyntax {
    lazy val label: SwiftToken     = createSwiftNode(_childrenMap("label")).asInstanceOf[SwiftToken]
    lazy val colon: SwiftToken     = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
    lazy val statement: StmtSyntax = createSwiftNode(_childrenMap("statement")).asInstanceOf[StmtSyntax]
  }
  ...
  case class LayoutRequirementSyntax(json: Value) extends Syntax {
    ...
    lazy val leftParen: Option[SwiftToken] =
      _childrenMap.get("leftParen").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val size: Option[SwiftToken]  = _childrenMap.get("size").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val comma: Option[SwiftToken] = _childrenMap.get("comma").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val alignment: Option[SwiftToken] =
  ...
  case class LifetimeSpecifierArgumentListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[LifetimeSpecifierArgumentSyntax] =
  ...
  case class LifetimeTypeSpecifierSyntax(json: Value) extends Syntax {
    lazy val dependsOnKeyword: SwiftToken = createSwiftNode(_childrenMap("dependsOnKeyword")).asInstanceOf[SwiftToken]
    lazy val leftParen: SwiftToken        = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    lazy val scopedKeyword: Option[SwiftToken] =
      _childrenMap.get("scopedKeyword").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val arguments: LifetimeSpecifierArgumentListSyntax =
  ...
  case class MacroDeclSyntax(json: Value)
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val macroKeyword: SwiftToken = createSwiftNode(_childrenMap("macroKeyword")).asInstanceOf[SwiftToken]
    lazy val name: SwiftToken         = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    lazy val genericParameterClause: Option[GenericParameterClauseSyntax] =
      _childrenMap.get("genericParameterClause").map(c => createSwiftNode(c).asInstanceOf[GenericParameterClauseSyntax])
    lazy val signature: FunctionSignatureSyntax =
      createSwiftNode(_childrenMap("signature")).asInstanceOf[FunctionSignatureSyntax]
    lazy val definition: Option[InitializerClauseSyntax] =
  ...
  case class MacroExpansionDeclSyntax(json: Value)
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val pound: SwiftToken = createSwiftNode(_childrenMap("pound")).asInstanceOf[SwiftToken]
    lazy val moduleSelector: Option[ModuleSelectorSyntax] =
      _childrenMap.get("moduleSelector").map(c => createSwiftNode(c).asInstanceOf[ModuleSelectorSyntax])
    lazy val macroName: SwiftToken = createSwiftNode(_childrenMap("macroName")).asInstanceOf[SwiftToken]
    lazy val genericArgumentClause: Option[GenericArgumentClauseSyntax] =
      _childrenMap.get("genericArgumentClause").map(c => createSwiftNode(c).asInstanceOf[GenericArgumentClauseSyntax])
    lazy val leftParen: Option[SwiftToken] =
      _childrenMap.get("leftParen").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
  ...
  case class MatchingPatternConditionSyntax(json: Value) extends Syntax {
    ...
    lazy val typeAnnotation: Option[TypeAnnotationSyntax] =
      _childrenMap.get("typeAnnotation").map(c => createSwiftNode(c).asInstanceOf[TypeAnnotationSyntax])
    lazy val initializer: InitializerClauseSyntax =
  ...
  case class MemberAccessExprSyntax(json: Value) extends ExprSyntax {
    lazy val base: Option[ExprSyntax] = _childrenMap.get("base").map(c => createSwiftNode(c).asInstanceOf[ExprSyntax])
  ...
  case class MemberBlockItemListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[MemberBlockItemSyntax] =
  ...
  case class MetatypeTypeSyntax(json: Value) extends TypeSyntax {
    lazy val baseType: TypeSyntax          = createSwiftNode(_childrenMap("baseType")).asInstanceOf[TypeSyntax]
    lazy val period: SwiftToken            = createSwiftNode(_childrenMap("period")).asInstanceOf[SwiftToken]
    lazy val metatypeSpecifier: SwiftToken = createSwiftNode(_childrenMap("metatypeSpecifier")).asInstanceOf[SwiftToken]
  }
  ...
  case class ModuleSelectorSyntax(json: Value) extends Syntax {
    lazy val moduleName: SwiftToken = createSwiftNode(_childrenMap("moduleName")).asInstanceOf[SwiftToken]
    lazy val colonColon: SwiftToken = createSwiftNode(_childrenMap("colonColon")).asInstanceOf[SwiftToken]
  }
  ...
  case class MultipleTrailingClosureElementListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[MultipleTrailingClosureElementSyntax] = json("children").arr.iterator
  ...
  case class MultipleTrailingClosureElementSyntax(json: Value) extends Syntax {
    lazy val label: SwiftToken          = createSwiftNode(_childrenMap("label")).asInstanceOf[SwiftToken]
    lazy val colon: SwiftToken          = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
    lazy val closure: ClosureExprSyntax = createSwiftNode(_childrenMap("closure")).asInstanceOf[ClosureExprSyntax]
  }
  ...
  case class NamedOpaqueReturnTypeSyntax(json: Value) extends TypeSyntax {
    lazy val genericParameterClause: GenericParameterClauseSyntax = createSwiftNode(
      _childrenMap("genericParameterClause")
  ...
  case class NilLiteralExprSyntax(json: Value) extends ExprSyntax {
    lazy val nilKeyword: SwiftToken = createSwiftNode(_childrenMap("nilKeyword")).asInstanceOf[SwiftToken]
  }
  ...
  case class NonisolatedSpecifierArgumentSyntax(json: Value) extends Syntax with Parenthesized {
    lazy val leftParen: SwiftToken         = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    lazy val nonsendingKeyword: SwiftToken = createSwiftNode(_childrenMap("nonsendingKeyword")).asInstanceOf[SwiftToken]
    lazy val rightParen: SwiftToken        = createSwiftNode(_childrenMap("rightParen")).asInstanceOf[SwiftToken]
  }
  ...
  case class NonisolatedTypeSpecifierSyntax(json: Value) extends Syntax {
    lazy val nonisolatedKeyword: SwiftToken =
      createSwiftNode(_childrenMap("nonisolatedKeyword")).asInstanceOf[SwiftToken]
    lazy val argument: Option[NonisolatedSpecifierArgumentSyntax] =
  ...
  case class ObjCSelectorPieceListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[ObjCSelectorPieceSyntax] =
  ...
  case class ObjCSelectorPieceSyntax(json: Value) extends Syntax {
    lazy val name: Option[TokenSyntax] = _childrenMap.get("name").map(c => createSwiftNode(c).asInstanceOf[TokenSyntax])
    lazy val colon: Option[SwiftToken] = _childrenMap.get("colon").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
  }
  ...
  case class OperatorDeclSyntax(json: Value) extends DeclSyntax with NamedDecl {
    lazy val fixitySpecifier: SwiftToken = createSwiftNode(_childrenMap("fixitySpecifier")).asInstanceOf[SwiftToken]
    lazy val operatorKeyword: SwiftToken = createSwiftNode(_childrenMap("operatorKeyword")).asInstanceOf[SwiftToken]
    lazy val name: SwiftToken            = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    lazy val operatorPrecedenceAndTypes: Option[OperatorPrecedenceAndTypesSyntax] = _childrenMap
  ...
  case class OperatorPrecedenceAndTypesSyntax(json: Value) extends Syntax {
    lazy val colon: SwiftToken           = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
    lazy val precedenceGroup: SwiftToken = createSwiftNode(_childrenMap("precedenceGroup")).asInstanceOf[SwiftToken]
    lazy val designatedTypes: DesignatedTypeListSyntax =
  ...
  case class OptionalBindingConditionSyntax(json: Value) extends Syntax {
    lazy val bindingSpecifier: SwiftToken = createSwiftNode(_childrenMap("bindingSpecifier")).asInstanceOf[SwiftToken]
    lazy val pattern: PatternSyntax       = createSwiftNode(_childrenMap("pattern")).asInstanceOf[PatternSyntax]
    lazy val typeAnnotation: Option[TypeAnnotationSyntax] =
      _childrenMap.get("typeAnnotation").map(c => createSwiftNode(c).asInstanceOf[TypeAnnotationSyntax])
    lazy val initializer: Option[InitializerClauseSyntax] =
  ...
  case class OptionalChainingExprSyntax(json: Value) extends ExprSyntax {
    lazy val expression: ExprSyntax   = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
    lazy val questionMark: SwiftToken = createSwiftNode(_childrenMap("questionMark")).asInstanceOf[SwiftToken]
  }
  ...
  case class PackElementExprSyntax(json: Value) extends ExprSyntax {
    lazy val eachKeyword: SwiftToken = createSwiftNode(_childrenMap("eachKeyword")).asInstanceOf[SwiftToken]
    lazy val pack: ExprSyntax        = createSwiftNode(_childrenMap("pack")).asInstanceOf[ExprSyntax]
  }
  ...
  case class PackElementTypeSyntax(json: Value) extends TypeSyntax {
    lazy val eachKeyword: SwiftToken = createSwiftNode(_childrenMap("eachKeyword")).asInstanceOf[SwiftToken]
    lazy val pack: TypeSyntax        = createSwiftNode(_childrenMap("pack")).asInstanceOf[TypeSyntax]
  }
  ...
  case class PackExpansionExprSyntax(json: Value) extends ExprSyntax {
    lazy val repeatKeyword: SwiftToken     = createSwiftNode(_childrenMap("repeatKeyword")).asInstanceOf[SwiftToken]
    lazy val repetitionPattern: ExprSyntax = createSwiftNode(_childrenMap("repetitionPattern")).asInstanceOf[ExprSyntax]
  }
  ...
  case class PackExpansionTypeSyntax(json: Value) extends TypeSyntax {
    lazy val repeatKeyword: SwiftToken     = createSwiftNode(_childrenMap("repeatKeyword")).asInstanceOf[SwiftToken]
    lazy val repetitionPattern: TypeSyntax = createSwiftNode(_childrenMap("repetitionPattern")).asInstanceOf[TypeSyntax]
  }
  ...
  case class PatternBindingListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[PatternBindingSyntax] =
  ...
  case class PatternBindingSyntax(json: Value) extends Syntax with WithTrailingComma {
    ...
    lazy val initializer: Option[InitializerClauseSyntax] =
      _childrenMap.get("initializer").map(c => createSwiftNode(c).asInstanceOf[InitializerClauseSyntax])
    lazy val accessorBlock: Option[AccessorBlockSyntax] =
  ...
  case class PlatformVersionItemListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[PlatformVersionItemSyntax] =
  ...
  case class PostfixIfConfigExprSyntax(json: Value) extends ExprSyntax {
    lazy val base: Option[ExprSyntax]   = _childrenMap.get("base").map(c => createSwiftNode(c).asInstanceOf[ExprSyntax])
    lazy val config: IfConfigDeclSyntax = createSwiftNode(_childrenMap("config")).asInstanceOf[IfConfigDeclSyntax]
  }
  ...
  case class PoundSourceLocationArgumentsSyntax(json: Value) extends Syntax {
    lazy val fileLabel: SwiftToken = createSwiftNode(_childrenMap("fileLabel")).asInstanceOf[SwiftToken]
    lazy val fileColon: SwiftToken = createSwiftNode(_childrenMap("fileColon")).asInstanceOf[SwiftToken]
    lazy val fileName: SimpleStringLiteralExprSyntax =
      createSwiftNode(_childrenMap("fileName")).asInstanceOf[SimpleStringLiteralExprSyntax]
    lazy val comma: SwiftToken      = createSwiftNode(_childrenMap("comma")).asInstanceOf[SwiftToken]
    lazy val lineLabel: SwiftToken  = createSwiftNode(_childrenMap("lineLabel")).asInstanceOf[SwiftToken]
    lazy val lineColon: SwiftToken  = createSwiftNode(_childrenMap("lineColon")).asInstanceOf[SwiftToken]
    lazy val lineNumber: SwiftToken = createSwiftNode(_childrenMap("lineNumber")).asInstanceOf[SwiftToken]
  }
  ...
  case class PoundSourceLocationSyntax(json: Value) extends DeclSyntax with Parenthesized {
    lazy val poundSourceLocation: SwiftToken =
      createSwiftNode(_childrenMap("poundSourceLocation")).asInstanceOf[SwiftToken]
    lazy val leftParen: SwiftToken = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    lazy val arguments: Option[PoundSourceLocationArgumentsSyntax] =
  ...
  case class PrecedenceGroupAssignmentSyntax(json: Value) extends Syntax {
    lazy val assignmentLabel: SwiftToken = createSwiftNode(_childrenMap("assignmentLabel")).asInstanceOf[SwiftToken]
    lazy val colon: SwiftToken           = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
    lazy val value: SwiftToken           = createSwiftNode(_childrenMap("value")).asInstanceOf[SwiftToken]
  }
  ...
  case class PrecedenceGroupAssociativitySyntax(json: Value) extends Syntax {
    lazy val associativityLabel: SwiftToken =
      createSwiftNode(_childrenMap("associativityLabel")).asInstanceOf[SwiftToken]
    lazy val colon: SwiftToken = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
    lazy val value: SwiftToken = createSwiftNode(_childrenMap("value")).asInstanceOf[SwiftToken]
  }
  ...
  case class PrecedenceGroupDeclSyntax(json: Value)
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val precedencegroupKeyword: SwiftToken =
      createSwiftNode(_childrenMap("precedencegroupKeyword")).asInstanceOf[SwiftToken]
    lazy val name: SwiftToken      = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    lazy val leftBrace: SwiftToken = createSwiftNode(_childrenMap("leftBrace")).asInstanceOf[SwiftToken]
    lazy val groupAttributes: PrecedenceGroupAttributeListSyntax =
  ...
  case class PrecedenceGroupNameListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[PrecedenceGroupNameSyntax] =
  ...
  case class PrecedenceGroupRelationSyntax(json: Value) extends Syntax {
    lazy val higherThanOrLowerThanLabel: SwiftToken =
      createSwiftNode(_childrenMap("higherThanOrLowerThanLabel")).asInstanceOf[SwiftToken]
    lazy val colon: SwiftToken = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
    lazy val precedenceGroups: PrecedenceGroupNameListSyntax =
  ...
  case class PrimaryAssociatedTypeClauseSyntax(json: Value) extends Syntax {
    lazy val leftAngle: SwiftToken = createSwiftNode(_childrenMap("leftAngle")).asInstanceOf[SwiftToken]
    lazy val primaryAssociatedTypes: PrimaryAssociatedTypeListSyntax = createSwiftNode(
  ...
  case class PrimaryAssociatedTypeListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[PrimaryAssociatedTypeSyntax] =
  ...
  case class ProtocolDeclSyntax(json: Value)
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val protocolKeyword: SwiftToken = createSwiftNode(_childrenMap("protocolKeyword")).asInstanceOf[SwiftToken]
    lazy val name: SwiftToken            = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    lazy val primaryAssociatedTypeClause: Option[PrimaryAssociatedTypeClauseSyntax] = _childrenMap
  ...
  case class RepeatStmtSyntax(json: Value) extends StmtSyntax with WithCodeBlock {
    lazy val repeatKeyword: SwiftToken = createSwiftNode(_childrenMap("repeatKeyword")).asInstanceOf[SwiftToken]
    lazy val body: CodeBlockSyntax     = createSwiftNode(_childrenMap("body")).asInstanceOf[CodeBlockSyntax]
    lazy val whileKeyword: SwiftToken  = createSwiftNode(_childrenMap("whileKeyword")).asInstanceOf[SwiftToken]
    lazy val condition: ExprSyntax     = createSwiftNode(_childrenMap("condition")).asInstanceOf[ExprSyntax]
  }
  ...
  case class SequenceExprSyntax(json: Value) extends ExprSyntax {
    lazy val elements: ExprListSyntax = createSwiftNode(_childrenMap("elements")).asInstanceOf[ExprListSyntax]
  }
  ...
  case class SimpleStringLiteralExprSyntax(json: Value) extends ExprSyntax {
    ...
    lazy val segments: SimpleStringLiteralSegmentListSyntax =
  ...
  case class SimpleStringLiteralSegmentListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[StringSegmentSyntax] =
  ...
  case class SomeOrAnyTypeSyntax(json: Value) extends TypeSyntax {
    lazy val someOrAnySpecifier: SwiftToken =
      createSwiftNode(_childrenMap("someOrAnySpecifier")).asInstanceOf[SwiftToken]
    lazy val constraint: TypeSyntax = createSwiftNode(_childrenMap("constraint")).asInstanceOf[TypeSyntax]
  }
  ...
  case class SourceFileSyntax(json: Value) extends Syntax with WithStatements {
    lazy val shebang: Option[SwiftToken] =
      _childrenMap.get("shebang").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val statements: CodeBlockItemListSyntax =
      createSwiftNode(_childrenMap("statements")).asInstanceOf[CodeBlockItemListSyntax]
    lazy val endOfFileToken: SwiftToken = createSwiftNode(_childrenMap("endOfFileToken")).asInstanceOf[SwiftToken]
  }
  ...
  case class SpecializeAvailabilityArgumentSyntax(json: Value) extends Syntax {
    lazy val availabilityLabel: SwiftToken = createSwiftNode(_childrenMap("availabilityLabel")).asInstanceOf[SwiftToken]
    lazy val colon: SwiftToken             = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
    lazy val availabilityArguments: AvailabilityArgumentListSyntax = createSwiftNode(
      _childrenMap("availabilityArguments")
    ).asInstanceOf[AvailabilityArgumentListSyntax]
    lazy val semicolon: SwiftToken = createSwiftNode(_childrenMap("semicolon")).asInstanceOf[SwiftToken]
  }
  ...
  case class SpecializedAttributeArgumentSyntax(json: Value) extends Syntax {
    lazy val genericWhereClause: GenericWhereClauseSyntax =
  ...
  case class StringLiteralSegmentListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[StringSegmentSyntax | ExpressionSegmentSyntax] = json("children").arr.iterator
  ...
  case class StringSegmentSyntax(json: Value) extends Syntax {
    lazy val content: SwiftToken = createSwiftNode(_childrenMap("content")).asInstanceOf[SwiftToken]
  }
  ...
  case class StructDeclSyntax(json: Value)
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val structKeyword: SwiftToken = createSwiftNode(_childrenMap("structKeyword")).asInstanceOf[SwiftToken]
    lazy val name: SwiftToken          = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    lazy val genericParameterClause: Option[GenericParameterClauseSyntax] =
      _childrenMap.get("genericParameterClause").map(c => createSwiftNode(c).asInstanceOf[GenericParameterClauseSyntax])
    lazy val inheritanceClause: Option[InheritanceClauseSyntax] =
  ...
  case class SubscriptDeclSyntax(json: Value)
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val subscriptKeyword: SwiftToken = createSwiftNode(_childrenMap("subscriptKeyword")).asInstanceOf[SwiftToken]
    lazy val genericParameterClause: Option[GenericParameterClauseSyntax] =
      _childrenMap.get("genericParameterClause").map(c => createSwiftNode(c).asInstanceOf[GenericParameterClauseSyntax])
    lazy val parameterClause: FunctionParameterClauseSyntax =
      createSwiftNode(_childrenMap("parameterClause")).asInstanceOf[FunctionParameterClauseSyntax]
  ...
  case class SuperExprSyntax(json: Value) extends ExprSyntax {
    lazy val superKeyword: SwiftToken = createSwiftNode(_childrenMap("superKeyword")).asInstanceOf[SwiftToken]
  }
  ...
  case class SuppressedTypeSyntax(json: Value) extends TypeSyntax {
    lazy val withoutTilde: SwiftToken = createSwiftNode(_childrenMap("withoutTilde")).asInstanceOf[SwiftToken]
    lazy val `type`: TypeSyntax       = createSwiftNode(_childrenMap("type")).asInstanceOf[TypeSyntax]
  }
  ...
  case class SwitchCaseItemListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[SwitchCaseItemSyntax] =
  ...
  case class SwitchCaseListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[SwitchCaseSyntax | IfConfigDeclSyntax] = json("children").arr.iterator
  ...
  case class SwitchCaseSyntax(json: Value) extends Syntax with WithStatements {
    lazy val attribute: Option[AttributeSyntax] =
      _childrenMap.get("attribute").map(c => createSwiftNode(c).asInstanceOf[AttributeSyntax])
    lazy val label: SwitchDefaultLabelSyntax | SwitchCaseLabelSyntax =
  ...
  case class SwitchDefaultLabelSyntax(json: Value) extends Syntax {
    lazy val defaultKeyword: SwiftToken = createSwiftNode(_childrenMap("defaultKeyword")).asInstanceOf[SwiftToken]
    lazy val colon: SwiftToken          = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
  }
  ...
  case class SwitchExprSyntax(json: Value) extends ExprSyntax with Braced {
    lazy val switchKeyword: SwiftToken   = createSwiftNode(_childrenMap("switchKeyword")).asInstanceOf[SwiftToken]
    lazy val subject: ExprSyntax         = createSwiftNode(_childrenMap("subject")).asInstanceOf[ExprSyntax]
    lazy val leftBrace: SwiftToken       = createSwiftNode(_childrenMap("leftBrace")).asInstanceOf[SwiftToken]
    lazy val cases: SwitchCaseListSyntax = createSwiftNode(_childrenMap("cases")).asInstanceOf[SwitchCaseListSyntax]
    lazy val rightBrace: SwiftToken      = createSwiftNode(_childrenMap("rightBrace")).asInstanceOf[SwiftToken]
  }
  ...
  case class TernaryExprSyntax(json: Value) extends ExprSyntax {
    lazy val condition: ExprSyntax      = createSwiftNode(_childrenMap("condition")).asInstanceOf[ExprSyntax]
    lazy val questionMark: SwiftToken   = createSwiftNode(_childrenMap("questionMark")).asInstanceOf[SwiftToken]
    lazy val thenExpression: ExprSyntax = createSwiftNode(_childrenMap("thenExpression")).asInstanceOf[ExprSyntax]
    lazy val colon: SwiftToken          = createSwiftNode(_childrenMap("colon")).asInstanceOf[SwiftToken]
    lazy val elseExpression: ExprSyntax = createSwiftNode(_childrenMap("elseExpression")).asInstanceOf[ExprSyntax]
  }
  ...
  case class ThenStmtSyntax(json: Value) extends StmtSyntax {
    lazy val thenKeyword: SwiftToken = createSwiftNode(_childrenMap("thenKeyword")).asInstanceOf[SwiftToken]
    lazy val expression: ExprSyntax  = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
  }
  ...
  case class ThrowStmtSyntax(json: Value) extends StmtSyntax {
    lazy val throwKeyword: SwiftToken = createSwiftNode(_childrenMap("throwKeyword")).asInstanceOf[SwiftToken]
    lazy val expression: ExprSyntax   = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
  }
  ...
  case class TryExprSyntax(json: Value) extends ExprSyntax {
    lazy val tryKeyword: SwiftToken = createSwiftNode(_childrenMap("tryKeyword")).asInstanceOf[SwiftToken]
    lazy val questionOrExclamationMark: Option[SwiftToken] =
      _childrenMap.get("questionOrExclamationMark").map(c => createSwiftNode(c).asInstanceOf[SwiftToken])
    lazy val expression: ExprSyntax = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
  }
  ...
  case class TuplePatternElementListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[TuplePatternElementSyntax] =
  ...
  case class TuplePatternSyntax(json: Value) extends PatternSyntax with Parenthesized {
    lazy val leftParen: SwiftToken = createSwiftNode(_childrenMap("leftParen")).asInstanceOf[SwiftToken]
    lazy val elements: TuplePatternElementListSyntax =
  ...
  case class TupleTypeElementListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[TupleTypeElementSyntax] =
  ...
  case class TupleTypeElementSyntax(json: Value) extends Syntax with WithTrailingComma {
    lazy val inoutKeyword: Option[SwiftToken] =
  ...
  case class TypeAliasDeclSyntax(json: Value)
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val typealiasKeyword: SwiftToken = createSwiftNode(_childrenMap("typealiasKeyword")).asInstanceOf[SwiftToken]
    lazy val name: SwiftToken             = createSwiftNode(_childrenMap("name")).asInstanceOf[SwiftToken]
    lazy val genericParameterClause: Option[GenericParameterClauseSyntax] =
      _childrenMap.get("genericParameterClause").map(c => createSwiftNode(c).asInstanceOf[GenericParameterClauseSyntax])
    lazy val initializer: TypeInitializerClauseSyntax =
  ...
  case class TypeSpecifierListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[SimpleTypeSpecifierSyntax | LifetimeTypeSpecifierSyntax | NonisolatedTypeSpecifierSyntax] =
      json("children").arr.iterator
        .map(c =>
          createSwiftNode(c)
  ...
  case class UnexpectedCodeDeclSyntax(json: Value) extends DeclSyntax {
    lazy val unexpectedCode: UnexpectedNodesSyntax =
  ...
  case class UnexpectedNodesSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[Syntax] =
      json("children").arr.iterator.map(c => createSwiftNode(c).asInstanceOf[Syntax]).toSeq
  }
  ...
  case class UnsafeExprSyntax(json: Value) extends ExprSyntax {
    lazy val unsafeKeyword: SwiftToken = createSwiftNode(_childrenMap("unsafeKeyword")).asInstanceOf[SwiftToken]
    lazy val expression: ExprSyntax    = createSwiftNode(_childrenMap("expression")).asInstanceOf[ExprSyntax]
  }
  ...
  case class UsingDeclSyntax(json: Value) extends DeclSyntax {
    lazy val usingKeyword: SwiftToken = createSwiftNode(_childrenMap("usingKeyword")).asInstanceOf[SwiftToken]
    lazy val specifier: AttributeSyntax | SwiftToken =
  ...
  case class VariableDeclSyntax(json: Value) extends DeclSyntax with WithAttributes with WithModifiers {
    ...
    lazy val modifiers: DeclModifierListSyntax =
      createSwiftNode(_childrenMap("modifiers")).asInstanceOf[DeclModifierListSyntax]
    lazy val bindingSpecifier: SwiftToken = createSwiftNode(_childrenMap("bindingSpecifier")).asInstanceOf[SwiftToken]
    lazy val bindings: PatternBindingListSyntax =
  ...
  case class VersionComponentListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[VersionComponentSyntax] =
  ...
  case class VersionComponentSyntax(json: Value) extends Syntax {
    lazy val period: SwiftToken = createSwiftNode(_childrenMap("period")).asInstanceOf[SwiftToken]
    lazy val number: SwiftToken = createSwiftNode(_childrenMap("number")).asInstanceOf[SwiftToken]
  }
  ...
  case class YieldStmtSyntax(json: Value) extends StmtSyntax {
    lazy val yieldKeyword: SwiftToken = createSwiftNode(_childrenMap("yieldKeyword")).asInstanceOf[SwiftToken]
    lazy val yieldedExpressions: YieldedExpressionsClauseSyntax | ExprSyntax = createSwiftNode(
  ...
  case class YieldedExpressionListSyntax(json: Value) extends SyntaxCollection {
    lazy val children: Seq[YieldedExpressionSyntax] =
