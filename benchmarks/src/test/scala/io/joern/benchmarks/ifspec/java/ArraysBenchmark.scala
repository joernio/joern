...
// ArrayCopyDirectLeak
class ArraysBenchmark1 extends IfspecArraysFixture(JAVA_EXT, 1) {
...
class ArraysBenchmark2 extends IfspecArraysFixture(JAVA_EXT, 2) {
...
class ArraysBenchmark3 extends IfspecArraysFixture(JAVA_EXT, 3) {
...
class ArraysBenchmark4 extends IfspecArraysFixture(JAVA_EXT, 4) {
...
class ArraysBenchmark5 extends IfspecArraysFixture(JAVA_EXT, 5) {
...
class ArraysBenchmark6 extends IfspecArraysFixture(JAVA_EXT, 6) {
...
// SimpleArraySize
class ArraysBenchmark8 extends IfspecArraysFixture(JAVA_EXT, 8) {
...
// Webstore1
class ArraysBenchmark9 extends IfspecArraysFixture(JAVA_EXT, 9) {
...
// Webstore2
class ArraysBenchmark10 extends IfspecArraysFixture(JAVA_EXT, 10) {
