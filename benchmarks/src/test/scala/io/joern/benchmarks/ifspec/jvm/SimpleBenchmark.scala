...
class SimpleBenchmark1 extends IfspecSimpleFixture(JVM_EXT, 1) {
...
class SimpleBenchmark2 extends IfspecSimpleFixture(JVM_EXT, 2) {
...
// CallContext
class SimpleBenchmark3 extends IfspecSimpleFixture(JVM_EXT, 3) {
...
// DeepCall1
class SimpleBenchmark4 extends IfspecSimpleFixture(JVM_EXT, 4) {
...
// DeepCall2
class SimpleBenchmark5 extends IfspecSimpleFixture(JVM_EXT, 5) {
...
// DirectAssignment
class SimpleBenchmark6 extends IfspecSimpleFixture(JVM_EXT, 6) {
...
class SimpleBenchmark7 extends IfspecSimpleFixture(JVM_EXT, 7) {
...
class SimpleBenchmark8 extends IfspecSimpleFixture(JVM_EXT, 8) {
...
// IFMethodContract1
class SimpleBenchmark9 extends IfspecSimpleFixture(JVM_EXT, 9) {
...
// IFMethodContract2
class SimpleBenchmark10 extends IfspecSimpleFixture(JVM_EXT, 10) {
...
// ObjectSensLeak
class SimpleBenchmark11 extends IfspecSimpleFixture(JVM_EXT, 11) {
...
// Polynomial
class SimpleBenchmark12 extends IfspecSimpleFixture(JVM_EXT, 12) {
...
class SimpleBenchmark13 extends IfspecSimpleFixture(JVM_EXT, 13) {
...
class SimpleBenchmark14 extends IfspecSimpleFixture(JVM_EXT, 14) {
...
class SimpleBenchmark15 extends IfspecSimpleFixture(JVM_EXT, 15) {
...
class SimpleBenchmark16 extends IfspecSimpleFixture(JVM_EXT, 16) {
...
// StaticDispatching
class SimpleBenchmark17 extends IfspecSimpleFixture(JVM_EXT, 17) {
