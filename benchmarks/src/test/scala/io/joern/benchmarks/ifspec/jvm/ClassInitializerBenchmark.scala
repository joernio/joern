...
class ClassInitializerBenchmark1 extends IfspecClassInitializerFixture(JVM_EXT, 1) {
...
class ClassInitializerBenchmark2 extends IfspecClassInitializerFixture(JVM_EXT, 2) {
...
class ClassInitializerBenchmark3 extends IfspecClassInitializerFixture(JVM_EXT, 3) {
...
class ClassInitializerBenchmark4 extends IfspecClassInitializerFixture(JVM_EXT, 4) {
...
class ClassInitializerBenchmark5 extends IfspecClassInitializerFixture(JVM_EXT, 5) {
...
class ClassInitializerBenchmark6 extends IfspecClassInitializerFixture(JVM_EXT, 6) {
...
class ClassInitializerBenchmark7 extends IfspecClassInitializerFixture(JVM_EXT, 7) {
