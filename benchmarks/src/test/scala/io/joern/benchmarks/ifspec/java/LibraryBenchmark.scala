...
class LibraryBenchmark1 extends IfspecLibraryFixture(JAVA_EXT, 1) {
...
class LibraryBenchmark2 extends IfspecLibraryFixture(JAVA_EXT, 2) {
...
// PasswordChecker
class LibraryBenchmark3 extends IfspecLibraryFixture(JAVA_EXT, 3) {
...
// SimpleListSize
class LibraryBenchmark4 extends IfspecLibraryFixture(JAVA_EXT, 4) {
...
class LibraryBenchmark5 extends IfspecLibraryFixture(JAVA_EXT, 5) {
...
// StringIntern
class LibraryBenchmark6 extends IfspecLibraryFixture(JAVA_EXT, 6) {
...
// TimeBomb
class LibraryBenchmark7 extends IfspecLibraryFixture(JAVA_EXT, 7) {
