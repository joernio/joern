...
// ConditionalLeakage
class ExceptionsBenchmark1 extends IfspecExceptionsFixture(JAVA_EXT, 1) {
...
class ExceptionsBenchmark2 extends IfspecExceptionsFixture(JAVA_EXT, 2) {
...
class ExceptionsBenchmark3 extends IfspecExceptionsFixture(JAVA_EXT, 3) {
...
class ExceptionsBenchmark4 extends IfspecExceptionsFixture(JAVA_EXT, 4) {
...
// ExceptionHandling
class ExceptionsBenchmark6 extends IfspecExceptionsFixture(JAVA_EXT, 6) {
