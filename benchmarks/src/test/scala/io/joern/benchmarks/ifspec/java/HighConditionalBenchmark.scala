...
import io.joern.benchmarks.BenchmarkTags.{Exceptions, ExplicitFlows, HighConditional, ImplicitFlows}
...
class HighConditionalBenchmark1 extends IfspecHighConditionalFixture(JAVA_EXT, 1) {
...
class HighConditionalBenchmark2 extends IfspecHighConditionalFixture(JAVA_EXT, 2) {
...
// IFLoop1
class HighConditionalBenchmark3 extends IfspecHighConditionalFixture(JAVA_EXT, 3) {
...
// IFLoop2
class HighConditionalBenchmark4 extends IfspecHighConditionalFixture(JAVA_EXT, 4) {
...
class HighConditionalBenchmark5 extends IfspecHighConditionalFixture(JAVA_EXT, 5) {
...
class HighConditionalBenchmark6 extends IfspecHighConditionalFixture(JAVA_EXT, 6) {
...
class HighConditionalBenchmark7 extends IfspecHighConditionalFixture(JAVA_EXT, 7) {
...
class HighConditionalBenchmark8 extends IfspecHighConditionalFixture(JAVA_EXT, 8) {
...
class HighConditionalBenchmark9 extends IfspecHighConditionalFixture(JAVA_EXT, 9) {
...
class HighConditionalBenchmark10 extends IfspecHighConditionalFixture(JAVA_EXT, 10) {
...
// SimpleTypes
class HighConditionalBenchmark11 extends IfspecHighConditionalFixture(JAVA_EXT, 11) {
...
// Webstore4
class HighConditionalBenchmark12 extends IfspecHighConditionalFixture(JAVA_EXT, 12) {
