...
class InterBenchmark1 extends SecuribenchMicroInterFixture(JVM_EXT, 1) {
  ...
  s"Inter$benchmarkNo line 46" should "report secure" taggedAs Inter in {
    assertIsSecure(cpg.literal(".*name.*"), cpg.call(".*println.*").lineNumber(46))
  }

}

class InterBenchmark2 extends SecuribenchMicroInterFixture(JVM_EXT, 2) {

  s"Inter$benchmarkNo line 44" should "report insecure" taggedAs Inter in {
    assertIsInsecure(cpg.literal(".*name.*"), cpg.call(".*println.*").lineNumber(44))
  }

  s"Inter$benchmarkNo line 45" should "report secure" taggedAs Inter in {
    assertIsSecure(cpg.literal(".*name.*"), cpg.call(".*println.*").lineNumber(45))
  }

}

class InterBenchmark3 extends SecuribenchMicroInterFixture(JVM_EXT, 3) {

  s"Inter$benchmarkNo line 84" should "report insecure" taggedAs Inter in {
    assertIsInsecure(cpg.literal(".*name.*"), cpg.call(".*println.*").lineNumber(84))
  }

  s"Inter$benchmarkNo line 94" should "report secure" taggedAs Inter in {
    assertIsSecure(cpg.literal(".*name.*"), cpg.call(".*println.*").lineNumber(94))
  }
...
class InterBenchmark5 extends SecuribenchMicroInterFixture(JVM_EXT, 5) {
...
class InterBenchmark6 extends SecuribenchMicroInterFixture(JVM_EXT, 6) {
...
class InterBenchmark7 extends SecuribenchMicroInterFixture(JVM_EXT, 7) {
...
class InterBenchmark8 extends SecuribenchMicroInterFixture(JVM_EXT, 8) {
...
class InterBenchmark9 extends SecuribenchMicroInterFixture(JVM_EXT, 9) {
  ...
  s"Inter$benchmarkNo line 53" should "report insecure" taggedAs Inter in {
    assertIsInsecure(cpg.literal(".*name.*"), cpg.call(".*println.*").lineNumber(53))
  }
