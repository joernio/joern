...
class ArraysBenchmark1 extends SecuribenchMicroArraysFixture(JAVA_EXT, 1) {
...
class ArraysBenchmark2 extends SecuribenchMicroArraysFixture(JAVA_EXT, 2) {
...
class ArraysBenchmark3 extends SecuribenchMicroArraysFixture(JAVA_EXT, 3) {
...
class ArraysBenchmark4 extends SecuribenchMicroArraysFixture(JAVA_EXT, 4) {
...
class ArraysBenchmark5 extends SecuribenchMicroArraysFixture(JAVA_EXT, 5) {
...
class ArraysBenchmark6 extends SecuribenchMicroArraysFixture(JAVA_EXT, 6) {
...
class ArraysBenchmark7 extends SecuribenchMicroArraysFixture(JAVA_EXT, 7) {
...
class ArraysBenchmark8 extends SecuribenchMicroArraysFixture(JAVA_EXT, 8) {
...
class ArraysBenchmark9 extends SecuribenchMicroArraysFixture(JAVA_EXT, 9) {
...
class ArraysBenchmark10 extends SecuribenchMicroArraysFixture(JAVA_EXT, 10) {
