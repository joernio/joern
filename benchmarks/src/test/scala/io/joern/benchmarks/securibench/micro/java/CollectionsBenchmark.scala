...
class CollectionsBenchmark1 extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "1") {
...
class CollectionsBenchmark2 extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "2") {
...
class CollectionsBenchmark3 extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "3") {
...
class CollectionsBenchmark4 extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "4") {
...
class CollectionsBenchmark5 extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "5") {
...
class CollectionsBenchmark6 extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "6") {
...
class CollectionsBenchmark7 extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "7") {

  s"Collections$benchmarkNo line 49" should "report secure" taggedAs Collections in {
    assertIsSecure(cpg.fieldAccess.code(".*FIELD_NAME.*"), cpg.call(".*println.*").lineNumber(49))
  }
...
class CollectionsBenchmark8 extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "8") {
...
class CollectionsBenchmark10 extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "10") {
  ...
  s"Collections$benchmarkNo line 61" should "report secure" taggedAs Collections in {
    assertIsSecure(cpg.fieldAccess.code(".*FIELD_NAME.*"), cpg.call(".*println.*").lineNumber(61))
  }

}

class CollectionsBenchmark11 extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "11") {

  s"Collections$benchmarkNo" should "report insecure" taggedAs Collections in {
    assertIsInsecure(cpg.fieldAccess.code(".*FIELD_NAME.*"), cpg.call(".*foo.*"))
  }

}

class CollectionsBenchmark11b extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "11b") {
...
class CollectionsBenchmark12 extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "12") {
...
class CollectionsBenchmark13 extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "13") {
...
class CollectionsBenchmark14 extends SecuribenchMicroCollectionsFixture(JAVA_EXT, "14") {
