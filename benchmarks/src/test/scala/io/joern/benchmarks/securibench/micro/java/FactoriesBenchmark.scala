...
class FactoriesBenchmark1 extends SecuribenchMicroFactoriesFixture(JAVA_EXT, 1) {
...
class FactoriesBenchmark2 extends SecuribenchMicroFactoriesFixture(JAVA_EXT, 2) {
...
class FactoriesBenchmark3 extends SecuribenchMicroFactoriesFixture(JAVA_EXT, 3) {
