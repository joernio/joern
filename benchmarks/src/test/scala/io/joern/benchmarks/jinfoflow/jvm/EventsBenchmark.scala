...
class EventsBenchmark1 extends JInfoFlowEventsFixture(JVM_EXT, 1) {
...
class EventsBenchmark2 extends JInfoFlowEventsFixture(JVM_EXT, 2) {
...
class EventsBenchmark3 extends JInfoFlowEventsFixture(JVM_EXT, 3) {
...
class EventsBenchmark4 extends JInfoFlowEventsFixture(JVM_EXT, 4) {
...
class EventsBenchmark5 extends JInfoFlowEventsFixture(JVM_EXT, 5) {
