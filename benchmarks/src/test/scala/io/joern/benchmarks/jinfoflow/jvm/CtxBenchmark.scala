...
class CtxBenchmark1 extends JInfoFlowCtxFixture(JVM_EXT, 1) {
...
// InstanceMethods
class CtxBenchmark2 extends JInfoFlowCtxFixture(JVM_EXT, 2) {
...
// OverwriteSinks
class CtxBenchmark3 extends JInfoFlowCtxFixture(JVM_EXT, 3) {
...
// OverwriteSources
class CtxBenchmark4 extends JInfoFlowCtxFixture(JVM_EXT, 4) {
...
// StaticMethods
class CtxBenchmark5 extends JInfoFlowCtxFixture(JVM_EXT, 5) {
